...

{
  ...
  items: [
    ...
    { name: "Completed Consultations", href: "/consultation/completed-consultation", icon: Users },
...
},
{
  ...
  items: [
    ...
    { name: "Record-Results", href: "/lab/record-results", icon: Home },    
    { name: "Lab Orders", href: "/lab/lab-orders", icon: Home },
    { name: "Manage Template", href: "/lab/manage-template", icon: Home },
  ],
},
{
  name: "Pharmacy",
